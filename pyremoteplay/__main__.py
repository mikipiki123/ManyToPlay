...
class CLIInstance:
    ...
    def run(self, stdscr):
        ...
        # sleep(2)
        self.controller.button("RIGHT","press")
        sleep(0.1)
        self.controller.button("RIGHT","release")
        sleep(2)

        with open("/tmp/my_pipe", "r") as fifo:
            while True:
                button = fifo.readline().strip()
                ...
                if not arg2:
                    ...
                    print("value = " + arg2)
                    self.controller.stick(button, arg1, float(arg2))
                    self.controller.stick(button, arg1, float(arg2))
